...
import { questionsMann } from './data/questions';
...
export default function BewertungMannPage({ answers, setAnswers }: Props) {
  ...
  const hotnessCore = questionsMann.slice(0, 7);
  const hotnessRest = questionsMann.slice(7, 12);
  const others = questionsMann.slice(12);
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        <button
          onClick={() => navigate('/bewertung-frau')}
          style={{
            padding: '1rem 2rem',
            fontSize: '1.2rem',
            background: '#ff69b4',
